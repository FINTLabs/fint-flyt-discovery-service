...
import no.novari.discovery.service.mapping.IntegrationMetadataMappingService;
...
class IntegrationMetadataServiceTest {
    ...
    void testVersionExists() {
        ...
        when(integrationMetadataRepository.existsBySourceApplicationIdAndSourceApplicationIntegrationIdAndVersion(
